...
export const env = {
    ...
    emailEnabled: process.env.NODE_ENV === 'test'
...
export const isEmailVerificationConfigured = Boolean((env.googleClientId && env.googleClientSecret && env.googleRefreshToken && env.smtpUser) ||
